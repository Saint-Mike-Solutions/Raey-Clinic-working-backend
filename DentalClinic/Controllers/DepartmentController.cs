...
namespace DentalClinic.Controllers
{
    ...
    public class DepartmentController : Controller
    {
        ...
        public async Task<ActionResult> AddMobileBanking(AddDepartmentDTO DTO)
        {
            try
            {

                return Ok(await _departmentService.AddDepartment(DTO));
            }
        ...
        public async Task<ActionResult> UpdateDepartment(UpdateDepartmentDTO DTO)
        {
            try
            {
                ...
                return Ok(await _departmentService.UpdateDepartment(DTO));
            }
            catch (KeyNotFoundException ex)
            {
                return NotFound(new ErrorResponse { Message = ex.Message });
        ...
        public async Task<ActionResult> DeleteMobileBanking(int id)
        {
            try
            {

                return Ok(await _departmentService.DeleteDepartments(id));
            }
            catch (KeyNotFoundException ex)
            {
                return NotFound(new ErrorResponse { Message = ex.Message });
