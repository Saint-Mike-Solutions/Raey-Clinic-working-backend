...
namespace DentalClinic.Controllers
{
    ...
    public class LaboratoryController : Controller
    {
        ...
        [HttpPost("AddUrinalysis")]
        public async Task<ActionResult> AddUrinalysis([FromBody] AddUrinalysisDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddUrinalysis(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddHematology")]
        public async Task<ActionResult> AddHema([FromBody] AddHematologyDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddHematology(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddSerology")]
        public async Task<ActionResult> AddSerology([FromBody] AddSerologyDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddSerology(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddStoolExamination")]
        public async Task<ActionResult> AddStool([FromBody] AddStoolExaminationDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddStoolExamination(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddMicroscopy")]
        public async Task<ActionResult> AddMicroscopy([FromBody] AddMicroscopyDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddMicroscopy(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddChemistry")]
        public async Task<ActionResult> AddChemistry([FromBody] AddChemistryDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddChemistry(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpPost("AddBacterology")]
        public async Task<ActionResult> AddBacterology([FromBody] AddBacterologyDTO DTO)
        {
            if (DTO == null)
            {
                return BadRequest(new ErrorResponse { Message = "Prescription data cannot be null." });
            ...
            try
            {
                var result = await _laboratoryService.AddBacterology(DTO);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
