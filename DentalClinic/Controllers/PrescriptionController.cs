...
namespace DentalClinic.Controllers
{
    ...
    public class PrescriptionController : Controller
    {
        ...
        [HttpGet("GepPrescriptionByPatient")]
        public async Task<ActionResult> GepPrescriptionByPatient(int id)
        {


            try
            {
                var result = await _prescriptionService.GetPrescriptionByPatient(id);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
        ...
        [HttpGet("GepPrescriptionByEmployee")]
        public async Task<ActionResult> GepPrescriptionEmployeeHandedOut(int id)
        {


            try
            {
                var result = await _prescriptionService.GetPrescriptionByEmployee(id);
                return Ok(result);
            }
            catch (KeyNotFoundException ex)
            {
