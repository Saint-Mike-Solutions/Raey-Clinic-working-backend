...
namespace DentalClinic.Migrations
{
    ...
    [Migration("20250214082145_fkchanges")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DentalClinic.Models.CompanyLabPrices", b =>
                {
                    b.Property<int>("CompanyLabPriceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequestList", b =>
                {
                    ...
                    b.Property<bool>("Hematology")
                        .HasColumnType("bit");

                    b.Property<int?>("MedicalRecoredId")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("SatusCounter")
                        .HasColumnType("int");

                    b.Property<bool>("Serology")
                        .HasColumnType("bit");

                    b.Property<string>("Status")
                        .HasColumnType("nvarchar(max)");

                    b.Property<bool>("StoolExamination")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequests", b =>
                {
                    ...
                    b.HasIndex("MedicalRecordMedical_RecordID")
                        .IsUnique()
                        .HasFilter("[MedicalRecordMedical_RecordID] IS NOT NULL");
            ...
            modelBuilder.Entity("DentalClinic.Models.MedicalRecord", b =>
                {
                    ...
                    b.Property<bool>("HasConsultationFee")
                        .HasColumnType("bit");
                    ...
                    b.Property<int?>("LaboratoryRequestsListId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LaboratoryRequestsListId");
            ...
            modelBuilder.Entity("DentalClinic.Models.Payment", b =>
                {
                    ...
                    b.Property<int?>("LaboratoryRequestsId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("LaboratoryRequestsId");
            ...
            modelBuilder.Entity("DentalClinic.Models.Employee", b =>
                {
                    b.HasOne("DentalClinic.Models.Department", null)
                        .WithMany("Employees")
                        .HasForeignKey("DepartmentID");

                    b.HasOne("DentalClinic.Models.Department", "Departments")
                        .WithMany()
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequestList", b =>
                {
                    b.HasOne("DentalClinic.Models.Employee", "Requester")
                        .WithMany()
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequests", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.MedicalRecord", null)
                        ...
                        .HasForeignKey("DentalClinic.Models.LaboratoryRequests", "MedicalRecordMedical_RecordID");
            ...
            modelBuilder.Entity("DentalClinic.Models.MedicalRecord", b =>
                {
                    b.HasOne("DentalClinic.Models.LaboratoryRequestList", "LaboratoryRequestsList")
                        .WithMany()
                        .HasForeignKey("LaboratoryRequestsListId");

                    b.HasOne("DentalClinic.Models.LaboratoryRequestList", null)
                        .WithOne("MedicalRecord")
                        .HasForeignKey("DentalClinic.Models.MedicalRecord", "Medical_RecordID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DentalClinic.Models.LaboratoryRequests", null)
                        .WithOne("MedicalRecord")
                        .HasForeignKey("DentalClinic.Models.MedicalRecord", "Medical_RecordID")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.Navigation("LaboratoryRequestsList");
            ...
            modelBuilder.Entity("DentalClinic.Models.Payment", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.MedicalRecord", null)
                        .WithOne("Payment")
                        .HasForeignKey("DentalClinic.Models.Payment", "Id")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("DentalClinic.Models.LaboratoryRequests", "LaboratoryRequests")
                        .WithMany()
                        .HasForeignKey("LaboratoryRequestsId");
            ...
            modelBuilder.Entity("DentalClinic.Models.Employee", b =>
                {
                    ...
                    b.Navigation("ListOfLaboratoryRequests");
