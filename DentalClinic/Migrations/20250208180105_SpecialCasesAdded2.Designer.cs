...
namespace DentalClinic.Migrations
{
    ...
    [Migration("20250208180105_SpecialCasesAdded2")]
    partial class SpecialCasesAdded2
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequestList", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.Patient", null)
                        .WithMany("LaboratoryRequestsList")
            ...
            modelBuilder.Entity("DentalClinic.Models.LaboratoryRequests", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.Patient", "Patient")
                        .WithOne("LaboratoryRequests")
                        .HasForeignKey("DentalClinic.Models.LaboratoryRequests", "PatientId");
            ...
            modelBuilder.Entity("DentalClinic.Models.Payment", b =>
                {
                    ...
                    b.HasOne("DentalClinic.Models.Patient", "Patient")
                        .WithOne("Payment")
                        .HasForeignKey("DentalClinic.Models.Payment", "PatientID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
